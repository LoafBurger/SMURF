...
public class Courts implements ActionListener {
    ...
    JLabel queue2 = new JLabel("Queue: ");
    ...
    Courts() {
        ...
        queue.setBounds(30, 160, 100, 30);
        queue.setFont(new Font(null, Font.PLAIN, 20));

        queue1.setBounds(150, 160, 100, 30);
        queue1.setFont(new Font(null, Font.PLAIN, 20));

        queue2.setBounds(270, 160, 100, 30);
        queue2.setFont(new Font(null, Font.PLAIN, 20));
